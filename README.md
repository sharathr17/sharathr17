...
GitHub: github.com/sharathr17  |  LinkedIn: linkedin.com/in/sharath-r-maravanthe  |  Portfolio: sharathrmaravanthe.vercel.app
👨‍💻 About Me
Hello! I'm Sharath R, currently pursuing my Master of Computer Applications (MCA) at R V Institute of Technology and Management, with an expected graduation year of 2027. I enjoy building practical applications, exploring data, developing responsive websites, and learning how modern applications are automated, containerized, and deployed.
...
Database	MySQL • SQL
DevOps & Cloud	Git • GitHub • Linux • Docker • AWS
Data Analytics	Pandas • NumPy • Matplotlib • Power BI • Excel • SQL
...
Responsive portfolio website for education, skills, projects, and professional profile.
Technologies: HTML • CSS • JavaScript • React
Live: https://sharathrmaravanthe.vercel.app/
2. 📊 Student Performance Analytics Dashboard
Analyze marks, attendance, subject performance, trends, and academic KPIs with dashboards.
Technologies: Python • Pandas • Matplotlib • Power BI • Excel • SQL
3. 🛒 E-Commerce Sales Analytics
Analyze revenue, orders, products, customers, regional performance, and monthly growth.
Technologies: Python • Pandas • SQL • Power BI • Excel
4. ⚙️ DevOps CI/CD Project
Practice source control, automated builds, testing, containerization, and cloud deployment.
Technologies: Git • GitHub Actions • Linux • Docker • AWS
5. 🌦️ Weather Data Analytics
Explore temperature, rainfall, humidity, seasonal patterns, and historical weather trends.
...
☁️ AWS
     ↓
🚀 Deploy
📈 GitHub Analytics — README Code
Paste the following Markdown into the special repository sharathr17/sharathr17 as README.md:
<div align="center">
